 ...
 * @author artea
 */
public class MenuEmple extends javax.swing.JPanel {

    /**
     * Se crea el new form del menu de empleados
     */
    public MenuEmple() {
        initComponents();
        // Establecer un tamaño predeterminado para el panel
     
    }

    /**
     * Este método se llama desde el constructor para inicializar el form.
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/logocliente_3.png"))); // NOI18N
        ...
        jLabel6.setText("SITUACIÓN SENTIMENTAL:");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Soltero(a)", "Casado(a)", "Unión Libre" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tipo A positivo (A+)", "Tipo A negativo (A-)", "Tipo B positivo (B+)", "Tipo B negativo (B-)", "Tipo AB positivo (AB+)", "Tipo AB negativo (AB-)", "Tipo O positivo (O+)", "Tipo O negativo (O-)" }));
